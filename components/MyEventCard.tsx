...
const MyEventCard: React.FC<MyEventsProps> = ({ post, onDelete, onEdit, showDetail }) => {
    return (
                ...
                <View style={styles.textContainerFavorit}>
                    <View style={{ flexDirection: 'column' }}>
                        <View style={styles.cardHeader}>
                            ...
                            <View>
                                <View style={styles.actionContainerMyEvent}>
                                    <View>
                                        <ShareButton
                                            title={post.title}
                                    ...
                                    <View style={{ width: 10 }} />
                                    <View style={styles.buttonContainerMyEvent}>
                                    ...
                                    <View style={styles.buttonContainerMyEvent}>
                                        <TouchableOpacity onPress={() => onDelete(post.id)}>
                                            <FontAwesome6 name="trash" solid size={18} style={styles.deleteButton} />
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
